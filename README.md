...
6. If a `run.err.expected` file exists, what the program wrote to standard error is compared against it, after the same path and stack-trace normalisation `run.out` gets.
